...
SELECT COUNT(offon) as COUNT FROM icr_spring.evaluator WHERE offon='offline';
</sql:query>
	...
	<div class="jumbotron">
		<table class='table table-striped'>
          ...
          <h1>
            ...
            <a role="button" class="btn btn-lg btn-primary" href="view_evaluators">Refresh Page</a>
          </h1>
